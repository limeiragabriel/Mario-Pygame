...
class Menu(tools._State):
    ...
    def setup_background(self):
        ...
        self.background = pg.transform.scale(self.background,
                                   (int(self.background_rect.width*c.MULTIPLICADOR_FUNDO),
                                    int(self.background_rect.height*c.MULTIPLICADOR_FUNDO)))
    ...
    def update(self, surface, keys, current_time):
        ...
        self.game_info[c.TEMPO_ATUAL] = self.current_time
    ...
    def reset_game_info(self):
        """================no caso de gameover ou restart==================="""
        self.game_info[c.TOTAL_MOEDAS] = 0
        self.game_info[c.PONTOS] = 0
        self.game_info[c.VIDAS] = 3
        self.game_info[c.TEMPO_ATUAL] = 0.0
        self.game_info[c.ESTADO_NIVEL] = None
